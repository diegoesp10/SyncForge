...
namespace Security.Migrations
{
    ...
    [Migration("20260925100819_SeedInitialSuperAdmin")]
    partial class SeedInitialSuperAdmin
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c9868f3-10df-41ba-b33a-46ae2a021001"),
                        ...
                        new
                        {
                            Id = new Guid("4c9868f3-10df-41ba-b33a-46ae2a021002"),
                        ...
                        new
                        {
                            Id = new Guid("4c9868f3-10df-41ba-b33a-46ae2a021003"),
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserRole<System.Guid>", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("4c9868f3-10df-41ba-b33a-46ae2a021010"),
                            RoleId = new Guid("4c9868f3-10df-41ba-b33a-46ae2a021003")
                        });
                });
            ...
            modelBuilder.Entity("Security.Identity.AppUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("4c9868f3-10df-41ba-b33a-46ae2a021010"),
                            AccessFailedCount = 0,
                            ...
                            UserName = "DiegoEspina"
                        });
                });

            modelBuilder.Entity("Security.Identity.AuthSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Security.Identity.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Security.Identity.AuthSession", b =>
                {
                    b.HasOne("Security.Identity.AppUser", "User")
                        .WithMany("Sessions")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
